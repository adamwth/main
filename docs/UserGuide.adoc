...
The guest who made the booking will be added to both the guest list and the archived guest list. [red]#Coming in v2.0# +
...
Checks out the room and its first (i.e. earliest) booking. +
The guest is deleted from the guest list and a receipt is generated for his expenses. [red]#Coming in v2.0# +
