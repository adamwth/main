...
Reassigns a guest and his booking from one room to another. +
[TIP]
You can only reassign to rooms that are not checked-in AND do not have overlapping bookings with the
guest's booking that you want to reassign.
