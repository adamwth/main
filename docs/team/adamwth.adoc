...
trial-and-error was conducted to determine the best design for this architecture, and ultimately Immutability was
selected to be the paradigm for the classes in the `Room` package. 
