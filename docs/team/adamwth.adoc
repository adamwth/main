...
** https://github.com/CS2103-AY1819S1-F11-2/main/blob/master/docs/UserGuide.adoc#check-in-room-code-checkin-code-span-class-image-img-src-images-icon-key-png-alt-icon-key-width-32-span[`checkin` command]
** https://github.com/CS2103-AY1819S1-F11-2/main/blob/master/docs/UserGuide.adoc#checkout-room-code-checkout-code-span-class-image-img-src-images-icon-key-png-alt-icon-key-width-32-span[`checkout` command]
** https://github.com/CS2103-AY1819S1-F11-2/main/blob/master/docs/UserGuide.adoc#reassigning-a-guest-to-another-room-code-reassign-code-span-class-image-img-src-images-icon-key-png-alt-icon-key-width-32-span[`reassign` command]
