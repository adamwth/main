...
. `VersionedConcierge#checkinRoom` will call `VersionedConcierge#addCheckedInGuest`
. `VersionedConcierge#addCheckedInGuest` will add the checked-in guest to the checked-in guest list
