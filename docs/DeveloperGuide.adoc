...
Expected: First booking is deleted. Guest Raichu is removed from the checked-in guest list and added to the archived guest list.
...
** Prerequisites: There is a booking in the room you want to reassign. Add a booking to an empty room by doing: +
`add n/Pichu p/81726354 e/pika@chu r/030 from/16/11/2018 to/20/11/2018`
** Test case: `reassign r/030 from/16/11/18 nr/031` +
Expected: Booking in room 030 that starts from 16/11/18 is reassigned to room 031 (which has no bookings prior).
